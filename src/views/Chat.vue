    ...
    <div class="row mt-3">
      <div class="col-lg-3">
        ...
        <div class="omotOstaliChatovi ">
          ...
          <span class=""><i class="fas fa-user-tie pr-2" style="font-size:40px;line-height:50px;"></i><div class="ostaliChatovi mb-3">Filip</div><div class="kolikoNovihPoruka mt-2">2</div></span>
          <span class=""><i class="fas fa-user-tie pr-2" style="font-size:40px;line-height:50px;"></i><div class="ostaliChatovi mb-3">Projekat takser</div></span>
          <span class=""><i class="fas fa-user-tie pr-2" style="font-size:40px;line-height:50px;"></i><div class="ostaliChatovi mb-3">Lorem ipsum dolor.</div><div class="kolikoNovihPoruka">5</div></span>
          <span class=""><i class="fas fa-user-tie pr-2" style="font-size:40px;line-height:50px;"></i><div class="ostaliChatovi mb-3">Lorem ipsum dolor sit amet.</div></span>
          <span class=""><i class="fas fa-user-tie pr-2" style="font-size:40px;line-height:50px;"></i><div class="ostaliChatovi mb-3">Lorem.</div><div class="kolikoNovihPoruka">1</div></span>
          <span class=""><i class="fas fa-user-tie pr-2" style="font-size:40px;line-height:50px;"></i><div class="ostaliChatovi mb-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</div></span>
          <span class=""><i class="fas fa-user-tie pr-2" style="font-size:40px;line-height:50px;"></i><div class="ostaliChatovi mb-3"></div></span>
          <span class=""><i class="fas fa-user-tie pr-2" style="font-size:40px;line-height:50px;"></i><div class="ostaliChatovi mb-3"></div></span>
          <span class=""><i class="fas fa-user-tie pr-2" style="font-size:40px;line-height:50px;"></i><div class="ostaliChatovi mb-3"></div></span>
          <span class=""><i class="fas fa-user-tie pr-2" style="font-size:40px;line-height:50px;"></i><div class="ostaliChatovi mb-3"></div></span>
          <span class=""><i class="fas fa-user-tie pr-2" style="font-size:40px;line-height:50px;"></i><div class="ostaliChatovi mb-3"></div></span>
      ...
      <div class="col-lg-3">
        ...
        <div class="omotOstaliChatovi members">
          ...
          <a data-toggle="modal" title="Nazad" data-target="#add" class="mx-auto">  <p style="font-size:20px;cursor:pointer"><i class="fas fa-plus" style="color:#6ab4d1"></i> Add member</p></a>
          <div class="member">
            <a data-toggle="modal" title="Info" data-target="#member" class="mx-auto"><span><i class="fas fa-circle pt-2 pr-2" style="font-size:10px;color:red"></i><p>Lazar</p></span></a>
            <span><i class="fas fa-circle pt-2 pr-2" style="font-size:10px;color:green"></i><p>Marko</p></span>
            <span><i class="fas fa-circle pt-2 pr-2" style="font-size:10px;color:red"></i><p>Filip</p></span>
            <span><i class="fas fa-circle pt-2 pr-2" style="font-size:10px;color:green"></i><p>Nemanja</p></span>
          </div>
        </div>
      </div>
  </div>
...
<!-- **************************** MEMBER INFO ******************************-->
  <div class="modal fade text-center text-center" id="member" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body form-group">
            <i class="fas fa-user"></i><h4>Lazar Markovic</h4>
            <hr>
